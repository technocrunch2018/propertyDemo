...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fa fa-ioxhost"></i> Manage Saler's Lead</h3>
        </div>
    </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/sellers_leads');?>" enctype = "multipart/form-data">
                            <div class="row">  
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6 radiobtn">
                                <input type="radio" id="buy-search" name="buy_rent" checked value="sell">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu style2">
                                        <li><a id = "res_rent_flat" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_rent_flat.xlsx');?>">Residential Rent Flat</a></li>
                                        <li><a id = "res_rent_house" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_rent_house.xlsx');?>">Residential Rent House</a></li>
                                        <li><a id = "res_rent_pent_house" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_rent_pent_house.xlsx');?>">Residential Rent Pent House</a></li>
                                        <li><a id = "res_rent_duplex_flat" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_rent_duplex_flat.xlsx');?>">Residential Rent Duplexflat</a></li>
                                        <li><a id = "res_rent_land" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_rent_land.xlsx');?>">Residential Rent Land</a></li>
                                        
                                        <li><a id = "res_buy_flat" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_buy_flat.xlsx');?>">Residential Buy Flat</a></li>
                                        <li><a id = "res_buy_house" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_buy_house.xlsx');?>">Residential Buy House</a></li>
                                        <li><a id = "res_buy_pent_house" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_buy_pent_house.xlsx');?>">Residential Buy Pent House</a></li>
                                        <li><a id = "res_buy_duplex_flat" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_buy_duplex_flat.xlsx');?>">Residential Buy Duplex Flat</a></li>
                                        <li><a id = "res_buy_land" href = "<?php echo base_url('Uploads/excels/lead/buyers/res_buy_land.xlsx');?>">Residential Buy Land</a></li>
                                              
                                        <li><a id = "com_rent_office" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_rent_office.xlsx');?>">Cummericial Rent Office</a></li>
                                        <li><a id = "com_rent_shop" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_rent_shop.xlsx');?>">Cummericial Rent Shop</a></li>
                                        <li><a id = "com_rent_warehoouse" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_rent_warehoouse.xlsx');?>">Cummericial Rent Warehouse</a></li>
                                        <li><a id = "com_rent_factory" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_rent_factory.xlsx');?>">Cummericial Rent Factory</a></li>
                                        <li><a id = "com_rent_land" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_rent_land.xlsx');?>">Cummericial Rent Land</a></li>
                                              
                                        <li><a id = "com_buy_office" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_buy_office.xlsx');?>">Cummericial Buy Office</a></li>
                                        <li><a id = "com_buy_shop" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_buy_shop.xlsx');?>">Cummericial Buy Shop</a></li>
                                        <li><a id = "com_buy_warehoouse" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_buy_warehoouse.xlsx');?>">Cummericial Buy Warehouse</a></li>
                                        <li><a id = "com_buy_factory" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_buy_factory.xlsx');?>">Cummericial Buy Factory</a></li>
                                        <li><a id = "com_buy_land" href = "<?php echo base_url('Uploads/excels/lead/buyers/com_buy_land.xlsx');?>">Cummericial Buy Land</a></li>
                                    </ul>
                ...
                <div class="x_content">
                    <table id="datatable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php if(!empty($seller_lead_list)){ ?>
                            <?php foreach($seller_lead_list as $i=>$row){ ?>
                            <tr>
                                ...
                                <td><?php if($row->email_verify == 1){ echo '<span title="Verified" class="label label-success">Verified</span>'; }else{ echo '<span title="Unverified" class="label label-warning">Unverified</span>'; } ?></td>
                                ...
                                <td><?php if($row->status == 0){echo '<i class="fa fa-clock-o"></i>'; }elseif($row->status == 1){echo '<i class="fa fa-check"></i>'; }elseif($row->status == 2){ echo '<i class="fa fa-ban"></i>'; }else{ echo '<i class="fa fa-hourglass-end"></i>'; } ?></td>
                                <td><?php if($row->in_process_flag == 0){echo '<span class="label label-secondary">Pending</span>'; }elseif($row->in_process_flag == 1){echo '<span class="label label-primary">In Process</span>'; } ?></td>
                               ...
                               <!--<td>
                                ...
                                <td>
                                    <a href="javascript:void(0);" onclick="edit_seller(<?php echo $row->post_id; ?>);"><i class="fa fa-pencil"></i></a>
                                    <?php if($this->session->userdata('user_type') != 'admin'){ ?>
                                     | <a onclick="confirm('Do You want to delete this record?');" href="<?php echo base_url();?>property/delete_property/<?php echo $row->post_id;?>"> <i class="fa fa-trash"></i></a>
                                    <?php } ?>
                                    <?php if($row->status == 0 || $row->status == 2){ ?>
                                    | <a onclick="confirm('Do You want to change status of this record?');" href="<?php echo base_url();?>property/approve_property/seller_residential_sale_flat/<?php echo $row->post_id;?>"> <i class="fa fa-check"></i></a>
                                    <?php }if($row->status == 0 || $row->status == 1){ ?>
                                    | <a onclick="confirm('Do You want to change status of this record?');" href="<?php echo base_url();?>property/reject_property/seller_residential_sale_flat/<?php echo $row->post_id;?>"> <i class="fa fa-ban"></i></a>
                                    <?php } ?>
                                </td>  
                            </tr>
                            <?php } ?>
