					...
					<form method="POST">
						<div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								<select name="l_f" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
									<option>---Select---</option>
									<option value="Done">South</option>
									<option value="Not Done">North</option>
