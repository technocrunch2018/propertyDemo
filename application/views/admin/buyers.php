    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-ioxhost"></i> Manage User Requirements</h3>
            </div>
        </div>
                    ...
                    <tbody>   
                            ...
                            <?php foreach($buyers as $i=>$row){ ?>
                              <tr>
                                ...
                                <td>
                                    <?php /*if($row->email_verify == 1){ echo '<span title="Verified" class="label label-success">Verified</span>'; }else{ echo '<span title="Unverified" class="label label-warning">Unverified</span>'; }*/ ?>
