...
$duplex_flat_id=$_POST['duplex_flat_id'];
...
<div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Duplex Flat List</h2>
                        <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">+ADD Duplex Flat</button>
                    ...
                    <div class="x_content">
                        <table id="datatable" class="table table-bordered table-striped table">
                            ...
                            <tbody>
                                <?php if(!empty($list_duplex_flat)){ ?>
                                <?php foreach($list_duplex_flat as $i=>$row){ ?>
                                <tr>
                                    <td><?php echo $i+1;?></td>
                                    <td><?php echo $row->pent_house_id;?></td>
                                    ...
                                    <td><?php echo $row->carpet_area;?><?php echo $row->carpet_area_nit;?></td>
                                    <td><?php echo $row->uper_floor;?></td>
                                                            ...
                                                            <p> 
                                                                <div class="container">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->swimming;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->community_hall;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->gym;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->club_house;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->indoor_game;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->outdoor_game;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->park;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->vigitor_parking;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->gas_pipe_line;?>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                            <?php echo $row->sarvant_room;?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </p>
                                ...
                                <div class="modal-dialog  modal-lg">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Duplex Flat</h4>
                                        </div>
                                        <div class="modal-body">
                                            <form method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <input type="hidden" name="duplex_flat_id" value="<?php echo rand(100000,9000000)?>" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
