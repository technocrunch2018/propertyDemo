...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2><h2>Not Interested Land List</h2></h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_residential_sale_land');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_residential_rent_land');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                    ...
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="blank" href="<?php echo base_url(); ?><?php echo $row->video_name;?>"><i style="color:red" class="fa fa-youtube-play" aria-hidden="true"></i></a></td>
                    ...
                    <form name="residential_land_form" id="residential_land_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="LandArea" id="LandArea" class="gui-input" value=""  >	  
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="landCoveredArea" id="landCoveredArea" class="gui-input" value=""  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="LandRoadWide" id="LandRoadWide" class="gui-input" value=""  >
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Existing Owner</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Land Nature</label><b style="color:red;">*</b>
