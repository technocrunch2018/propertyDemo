<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Not Interested Flat List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_residential_sale_flat');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_residential_rent_flat');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                    ...
                    <form name="residential_flat_form" id="residential_flat_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="number" class="" size=20 maxlength=15 name="phone" id="phone" onKeyPress="if(this.value.length==15) return false;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" onkeyup="load_locations(this.value)"> 
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="text" name="pincode" id="pincode" onKeyPress="if(this.value.length==7) return false;" />
                            </div>
                           ...
                           <!-- <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="flat_SuperBuildupArea" id="flat_SuperBuildupArea" class="gui-input" value="" onkeyup="check_area()" >	  
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="flat_BuildupArea" id="flat_BuildupArea" class="gui-input" onkeyup="check_area()" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="flat_BuildupArea_Unit" name="flat_BuildupArea_Unit" value=""  >
                                    <option hidden value="" >Unit</option>
                                    <option disabled >Select one </option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="flat_CarpetArea" id="flat_CarpetArea" class="gui-input" value="" onkeyup="check_area()" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Age Of Property</label><b style="color:red;">*</b>
