...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Not Interested House/Bunglow List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_residential_sale_house_bunglow');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_residential_rent_house_bunglow');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                    ...
                    <form name="residential_house_form" id="residential_house_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="number" class="input--style-5" size=20 maxlength=15 name="phone" id="phone" min="15" onKeyPress="if(this.value.length==15) return false;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" name="complex_society_building" id="complex_society_building" style="text-transform: uppercase;"  />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input type="text" name="blockno" id="blockno" style="text-transform: uppercase;"  />
                                </div>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Flat No</label><b style="color:red;">*</b>
                                    <input type="text" name="flatno" id="flatno" style="text-transform: uppercase;"  />
                                </div>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input type="number" name="security_deposite" id="security_deposite" multiple   />
                                </div>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Rent Per Month</label><b style="color:red;">*</b>
                                    <input type="number" name="rentPerMonth" id="rentPerMonth" multiple   />
                                </div>
                                <?php }elseif($rent_sell == 'Sell'){ ?>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Net Sale Amount</label><b style="color:red;">*</b>
                                    <input type="number" name="net_amount" id="net_amount" multiple   />
                                </div>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Booking Amount</label><b style="color:red;">*</b>
                                    <input type="number" name="amount" id="amount" multiple   />
                                </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="house_SuperBuildupArea" id="house_SuperBuildupArea" class="gui-input" value="" onkeyup="check_area()" >	  
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="house_BuildupArea" id="house_BuildupArea" class="gui-input" onkeyup="check_area()" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="house_CarpetArea" id="house_CarpetArea" class="gui-input" value="" onkeyup="check_area()" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Total Land Area</label><b style="color:red;">*</b>
                                <input  type="number" name="house_TotalLandArea" id="house_TotalLandArea" class="gui-input" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Total Covered Area</label><b style="color:red;">*</b>
                                <input  type="number" name="house_TotalCoveredLandArea" id="house_TotalCoveredLandArea" class="gui-input" value=""  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Total Uncovered Area</label><b style="color:red;">*</b>
                                <input  type="number" name="house_TotalUncoveredLandArea" id="house_TotalUncoveredLandArea" class="gui-input" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
