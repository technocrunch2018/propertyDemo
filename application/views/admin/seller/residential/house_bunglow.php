...
<?php 
    if($rent_sell == 'Rent'){
        $current_page = 'seller_residential_rent_house_bunglow';
    }else{
        $current_page = 'seller_residential_sale_house_bunglow';
    }
?>
...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fa fa-ioxhost"></i> Manage House/Bunglow For Sale</h3>
        </div>
    </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_res_rent_house_bunglow');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_res_house_bunglow');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/Flat/Saller_res_rent_house_bunglow.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/Flat/Saller_res_sale_house_bunglow.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>House/Bunglow List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_residential_sale_house_bunglow_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_residential_rent_house_bunglow_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php } ?>
                ...
                <div class="x_content">
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>
                            ...
                            <?php foreach($house_list as $i=>$row){ ?>
                            <tr>
                                <td><?php echo $i+1;?></td>
                                ...
                                <td><?php echo $row->house_SuperBuildupArea.' '.$row->house_SuperBuildupArea_Unit;?></td>
                                <td><?php echo $row->house_Room;?></td>
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add House / Bunglow For Sale</h4>
                </div>
                <div class="modal-body">
                    <form name="residential_house_form" id="residential_house_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <input type="hidden" name="residential" value="HouseorBanglow" id="residential"   />
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" name="name" id="name" style="text-transform: uppercase;" required />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Phone</label>
                                <input type="number" class="input--style-5" size=20 maxlength=15 name="phone" id="phone" onkeypress="return event.charCode >= 48" min="0" onKeyPress="if(this.value.length==15) return false;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>E-mail</label>
                                <input type="email" name="email" id="house_email" style="text-transform: lowercase;"  />
                            </div>


                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>State</label><b style="color:red;">*</b>
                                <select id="state" name="state" onchange="get_city_list_by_state_name(this.value);" required>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="city" name="city" onchange="get_pincode_list_by_city_name(this.value)" required>
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" name="complex_society_building" id="complex_society_building" style="text-transform: uppercase;"  required/>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input type="text" name="blockno" id="blockno" style="text-transform: uppercase;" required />
                                </div>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>House No</label><b style="color:red;">*</b>
                                    <input type="text" name="flatno" id="flatno" style="text-transform: uppercase;" required />
                                </div>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input type="number" name="security_deposite" id="security_deposite" onkeypress="return event.charCode >= 48" min="0" multiple   />
                                </div>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Rent Per Month</label><b style="color:red;">*</b>
                                    <input type="number" name="rentPerMonth" id="rentPerMonth" onkeypress="return event.charCode >= 48" min="0" multiple required />
                                </div>
                                <?php }elseif($rent_sell == 'Sell'){ ?>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Net Sale Amount</label><b style="color:red;">*</b>
                                    <input type="number" name="net_amount" id="net_amount" onkeypress="return event.charCode >= 48" min="0" multiple required />
                                </div>
                                
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    <label>Booking Amount</label>
                                    <input type="number" name="amount" id="amount" onkeypress="return event.charCode >= 48" min="0" multiple   />
                                </div>
                                
                                <!---- Remove this Area ------
                                <div class="col-md-2 col-sm-6 col-xs-6">
                                    <label>Per Unit</label><b style="color:red;">*</b>
                                    <input type="text" name="per_unit" id="per_unit" multiple   />
                                </div>
                                ---------------------------->
                                <?php } ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="house_Room" name="house_Room" required>
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="house_Bathroom" name="house_Bathroom" required>
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="house_Balcony" name="house_Balcony" required>
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                                    <option value="<?php echo $i; ?>" ><?php echo $i; ?></option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="house_Kitchen" name="house_Kitchen" required>
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="house_SuperBuildupArea" id="house_SuperBuildupArea" class="gui-input" value="" onkeypress="return event.charCode >= 48" min="0" onkeyup="check_area()" >	  
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="house_BuildupArea" id="house_BuildupArea" onkeypress="return event.charCode >= 48" min="0" required class="gui-input" onkeyup="check_area()" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
                            
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="house_BuildupAreaUnit" name="house_BuildupAreaUnit" required >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin:0;padding:0;">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label style="color:red;" id="house_SuperBuildupArea_error"></label>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label style="color:red;" id="house_BuildupArea_error"></label>
                                </div>
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Carpet Area</label>
                                <input  type="number" name="house_CarpetArea" id="house_CarpetArea" class="gui-input" value="" onkeypress="return event.charCode >= 48" min="0" onkeyup="check_area()" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="house_TotalLandArea" id="house_TotalLandArea" class="gui-input" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <label style="color:red;" id="house_CarpetArea_error"></label>
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Total Covered Area</label>
                                <input  type="number" name="house_TotalCoveredLandArea" id="house_TotalCoveredLandArea" class="gui-input" value="" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Total Uncovered Area</label>
                                <input  type="number" name="house_TotalUncoveredLandArea" id="house_TotalUncoveredLandArea" class="gui-input" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
        			    ...
        			    <div class="col-md-6 col-sm-6 col-xs-12 xs-pt-10" id="PossessionDateDiv" style="display:none;">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6">
                                <label>Parking Upto</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" id="fileUploadDiv" style="margin:0;padding:0;">
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="file-drop-area">
                                        ...
                                        <input class="file-input" type="hidden" name="prevUploadImages" id="prevUploadImages" value=""  onblur="checkValue(this)" >
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <input type="file" name="UploadImages[]" id="UploadImages" value="" multiple   />
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <input type="file" name="UploadVideos" id="UploadVideos"   />
...
<script>
	function add()
	{
        ...
        $("#house_Room").val('');
        $("#house_Balcony").val('');
        $("#house_SuperBuildupArea").val('');
        $("#house_CarpetArea").val('');
        $("#house_TotalCoveredLandArea").val('');
        $("#house_SuperBuildupArea_Unit").val('');
        $("#house_Carpet_Unit").val('');
        $("#house_TotalCoveredLandArea_unit").val('');
        $("#house_TotalFloor").val('');
        $("#house_Bathroom").val('');
        $("#house_Kitchen").val('');
        $("#house_BuildupArea").val('');
        $("#house_TotalLandArea").val('');
        $("#house_TotalUncoveredLandArea").val('');
        $("#house_BuildupAreaUnit").val('');
        $("#house_TotalLandArea_Unit").val('');
        $("#house_TotalUncoveredLandArea_Unit").val('');
...
<script>
    function edit_seller(post_id, mode)
    {
        ...
        ({
            ...
            data: {post_id:post_id, property_type:'HouseorBanglow'},
            dataType: 'json',
            success: function(data)
            {
                ...
                $("#house_Room").val(data['house_Room']);
                $("#house_Balcony").val(data['house_Balcony']);
                $("#house_SuperBuildupArea").val(data['house_SuperBuildupArea']);
                $("#house_CarpetArea").val(data['house_CarpetArea']);
                $("#house_TotalCoveredLandArea").val(data['house_TotalCoveredLandArea']);
                $("#house_SuperBuildupArea_Unit").val(data['house_SuperBuildupArea_Unit']);
                $("#house_Carpet_Unit").val(data['house_Carpet_Unit']);
                $("#house_TotalCoveredLandArea_unit").val(data['house_TotalCoveredLandArea_unit']);
                $("#house_TotalFloor").val(data['house_TotalFloor']);
                $("#house_Bathroom").val(data['house_Bathroom']);
                $("#house_Kitchen").val(data['house_Kitchen']);
                $("#house_BuildupArea").val(data['house_BuildupArea']);
                $("#house_TotalLandArea").val(data['house_TotalLandArea']);
                $("#house_TotalUncoveredLandArea").val(data['house_TotalUncoveredLandArea']);
                $("#house_BuildupAreaUnit").val(data['house_BuildupAreaUnit']);
                $("#house_TotalLandArea_Unit").val(data['house_TotalLandArea_Unit']);
                $("#house_TotalUncoveredLandArea_Unit").val(data['house_TotalUncoveredLandArea_Unit']);
