...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Not Interested Pent House List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_residential_sale_pent_house');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_residential_rent_pent_house');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input  type="number" name="pent_super_buildup_area" id="pent_super_buildup_area" class="gui-input" value="" onkeyup="check_area()" >	  
                                </div>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input  type="number" name="pent_buildup_area" id="pent_buildup_area" class="gui-input" onkeyup="check_area()" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin:0;padding:0;">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    ...
                                    <input  type="number" name="pent_carpet_area" id="pent_carpet_area" class="gui-input" value="" onkeyup="check_area()" >
                                </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="open_terrace" id="open_terrace" class="gui-input" value="<?php if(!empty($flat_details)){ echo $flat_details->flat_BuildupArea; } ?>" >
                            </div>
