            ...
            <div class="x_panel">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_rent_land');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_sell_land');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_rent_land.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_sell_land.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
            
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Land List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_land_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_land_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php } ?>
                    ...
                    <form name="commercial_land_form" id="commercial_land_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="LandArea" id="LandArea"  value="" onkeypress="return event.charCode >= 48" min="0"  >	  
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input  type="number" name="landCoveredArea" id="landCoveredArea" value="" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Is the Existing Owner</label>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="LandRoadWide" id="LandRoadWide" value="" onkeypress="return event.charCode >= 48" min="0"  >
                            </div>
