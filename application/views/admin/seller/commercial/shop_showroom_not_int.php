...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Not Intrested Shop List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_shop_showroom');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_shop_showroom');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                    ...
                    <form name="commercial_shop_form" id="commercial_shop_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" size=20 maxlength=15 name="phone" id="phone" onKeyPress="if(this.value.length==15) return false;">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopFrontage" id="shopFrontage"  value="<?php if(!empty($shop_details)){ echo $shop_details->shopFrontage; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopSuperBuildupArea" id="shopSuperBuildupArea" onkeyup="check_area()" value="<?php if(!empty($shop_details)){ echo $shop_details->shopSuperBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopBuildupArea" id="shopBuildupArea" onkeyup="check_area()" value="<?php if(!empty($shop_details)){ echo $shop_details->shopBuildupArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopCoveredArea" id="shopCoveredArea" onkeyup="check_area()" value="<?php if(!empty($shop_details)){ echo $shop_details->shopCoveredArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopOpenArea" id="shopOpenArea" value="<?php if(!empty($shop_details)){ echo $shop_details->shopOpenArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopBathroom" id="shopBathroom" value="<?php if(!empty($shop_details)){ echo $shop_details->shopBathroom; } ?>" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Used For</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopPentry" id="shopPentry"  value="<?php if(!empty($shop_details)){ echo $shop_details->shopPentry; } ?>"  > 
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopRoadWide" id="shopRoadWide" value="<?php if(!empty($shop_details)){ echo $shop_details->shopRoadWide; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="shopElectricPower" id="shopElectricPower" value="<?php if(!empty($shop_details)){ echo $shop_details->shopElectricPower; } ?>"  >
                            </div>
