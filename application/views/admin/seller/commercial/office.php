...
<?php 
    if($rent_sell == 'Rent'){
        $current_page = 'seller_commercial_rent_office';
    }else{
        $current_page = 'seller_commercial_sale_office';
    }
?>
            ...
            <div class="x_panel">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_rent_office');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_sell_office');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_rent_office.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_sell_office.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Office List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_office_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_office_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php } ?>
                ...
                <div class="x_content">
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>
                            ...
                            <?php foreach($office_list as $i=>$row){ ?>
                            <tr>
                                <td><?php echo $i+1;?></td>
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Office For Sale</h4>
                </div>
                <div class="modal-body">
                    <form name="commercial_office_form" id="commercial_office_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <input type="hidden" name="residential" value="Office" id="residential"  onblur="checkValue(this)"  />
                            ...
                            <div class="col-md-3 col-sm-6=3 col-xs-6">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>E-mail</label>
                                <input type="text" name="email" id="office_email" onblur="checkValue(this)" style="text-transform: lowercase;" />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Office No</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeSuperBuildupArea"   id="officeSuperBuildupArea" class="gui-input" onkeypress="return event.charCode >= 48" min="0" onkeyup="check_area()" value="<?php if(!empty($office_details)){ echo $office_details->officeSuperBuildupArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeBuildupArea" id="officeBuildupArea" onkeyup="check_area()" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($office_details)){ echo $office_details->officeBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin:0;padding:0;">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label style="color:red;" id="officeSuperBuildupArea_error"></label>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label style="color:red;" id="officeBuildupArea_error"></label>
                                </div>
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Carpet Area</label>
                                <input type="number" name="officeCarpetArea"  id="officeCarpetArea" onkeyup="check_area()" class="gui-input" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($office_details)){ echo $office_details->officeCarpetArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <label style="color:red;" id="officeCarpetArea_error"></label>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Pentry</label>
                                <input type="number" name="Pentryoffice" id="Pentryoffice" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($office_details)){ echo $office_details->Pentryoffice; } ?>">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeBathroom" id="officeBathroom" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($office_details)){ echo $office_details->officeBathroom; } ?>"  >
                            </div>
...
<script>
	function add()
	{
        ...
        $("#officeNumberofCabin").val('');
        $("#officeSuperBuildupArea").val('');
        $("#officeCarpetArea").val('');
        $("#officeSuperBuildupAreaUnit").val('');
        $("#officeCarpetUnit").val('');
        $("#Flooroffice").val('');
        $("#Pentryoffice").val('');
        $("#PentryofficeUsedFor").val('');
        $("#officeNumberofWorkStation").val('');
        $("#officeBuildupArea").val('');
        $("#officeBuildupAreaUnit").val('');
        $("#officeAC").val('');
        $("#officeTotalFloor").val('');
        $("#officeBathroom").val('');
        $("#BathroomofficeUsedFor").val('');
...
<script>
    function edit_seller(post_id, mode)
    {
        ...
        ({
            ...
            data: {post_id:post_id, property_type:'Office'},
            dataType: 'json',
            success: function(data)
            {
                ...
                $("#officeNumberofCabin").val(data['officeNumberofCabin']);
                $("#officeSuperBuildupArea").val(data['officeSuperBuildupArea']);
                $("#officeCarpetArea").val(data['officeCarpetArea']);
                $("#officeSuperBuildupAreaUnit").val(data['officeSuperBuildupAreaUnit']);
                $("#officeCarpetUnit").val(data['officeCarpetUnit']);
                $("#Flooroffice").val(data['Flooroffice']);
                $("#Pentryoffice").val(data['Pentryoffice']);
                $("#PentryofficeUsedFor").val(data['PentryofficeUsedFor']);
                $("#officeNumberofWorkStation").val(data['officeNumberofWorkStation']);
                $("#officeBuildupArea").val(data['officeBuildupArea']);
                $("#officeBuildupAreaUnit").val(data['officeBuildupAreaUnit']);
                $("#officeAC").val(data['officeAC']);
                $("#officeTotalFloor").val(data['officeTotalFloor']);
                $("#officeBathroom").val(data['officeBathroom']);
                $("#BathroomofficeUsedFor").val(data['BathroomofficeUsedFor']);
    ...
    function check_area(){
        if(parseInt($('#officeBuildupArea').val()) < parseInt($('#officeSuperBuildupArea').val())){
            $('#officeBuildupArea_error').html('Should be less than superbuiltup area');
        }else{
            $('#officeBuildupArea_error').html('');
        }
        if(parseInt($('#officeCarpetArea').val()) > parseInt($('#officeBuildupArea').val())){
            $('#officeCarpetArea_error').html('Should be less than builtup area');
        }else{
            $('#officeCarpetArea_error').html('');
        }
    }
