...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Not Intrested Office List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_office');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_office');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                    ...
                    <form name="commercial_office_form" id="commercial_office_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="number" class="input--style-5" size=20 maxlength=15 name="phone" id="phone" onKeyPress="if(this.value.length==15) return false;">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeSuperBuildupArea"   id="officeSuperBuildupArea" class="gui-input" onkeyup="check_area()" value="<?php if(!empty($office_details)){ echo $office_details->officeSuperBuildupArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeBuildupArea" id="officeBuildupArea" onkeyup="check_area()" value="<?php if(!empty($office_details)){ echo $office_details->officeBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeCarpetArea"  id="officeCarpetArea" onkeyup="check_area()" class="gui-input" value="<?php if(!empty($office_details)){ echo $office_details->officeCarpetArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="Pentryoffice" id="Pentryoffice" value="<?php if(!empty($office_details)){ echo $office_details->Pentryoffice; } ?>">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="officeBathroom" id="officeBathroom" value="<?php if(!empty($office_details)){ echo $office_details->officeBathroom; } ?>"  >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Bathroom Used For</label><b style="color:red;">*</b>
