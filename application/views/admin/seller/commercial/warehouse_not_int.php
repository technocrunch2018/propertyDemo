...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Not Intrested Warehouse List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_warehouse');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_warehouse');?>"><button type="button" class="effect effect-5 blue pull-right">Intrested</button></a>
                    <?php } ?>
                ...
                <div class="modal-body">
                    <form name="commercial_warehouse_form" id="commercial_warehouse_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Mobile</label><b style="color:red;">*</b>
                                <input type="number" size=20 maxlength=15 name="mobile1" id="mobile1" onblur="checkValue(this)" onKeyPress="if(this.value.length==15) return false;" />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseSuperBuildupArea" id="warehouseSuperBuildupArea" onkeyup="check_area()" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseSuperBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseBuildupArea" id="warehouseBuildupArea" onkeyup="check_area()" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="CoveredArea" id="CoveredArea" onkeyup="check_area()" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseBuildupArea; } ?>" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label></label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseOpenArea" id="warehouseOpenArea" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseOpenArea; } ?>" >
                            </div>
                            
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Open Unit</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehousePentry" id="warehousePentry" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehousePentry; } ?>" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Pentry Used For</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseRoadWide" id="warehouseRoadWide" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseRoadWide; } ?>"  >
                            </div>
                                
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Road Wide Unit</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseBathroom" id="warehouseBathroom" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseBathroom; } ?>" >
                            </div>
