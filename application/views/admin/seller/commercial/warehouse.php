...
<?php 
    if($rent_sell == 'Rent'){
        $current_page = 'seller_commercial_rent_warehouse';
    }else{
        $current_page = 'seller_commercial_sale_warehouse';
    }
?>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_rent_warehouse');?>" enctype = "multipart/form-data">
                        <?php }else{?>
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_sell_warehouse');?>" enctype = "multipart/form-data">
                            <?php }?>
                        <div class="tab"> 
                ...
                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                    <?php if($rent_sell == 'Rent'){ ?>
                    <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_rent_warehouse.xlsx');?>">Download Demo File</a>
                    <?php }else{?>
                    <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_sell_warehouse.xlsx');?>">Download Demo File</a>
                    <?php }?>
                </div>
            </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Warehouse List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_warehouse_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_warehouse_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php } ?>
                ...
                <div class="x_content">
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>
                            ...
                            <?php foreach($warehouse_list as $i=>$row){ ?>
                            <tr>
                                <td><?php echo $i+1;?></td>
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Warehouse For Sale</h4>
                </div>
                <div class="modal-body">
                    <form name="commercial_warehouse_form" id="commercial_warehouse_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Warehouse No</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseSuperBuildupArea" id="warehouseSuperBuildupArea" onkeypress="return event.charCode >= 48" min="0" onkeyup="check_area()" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseSuperBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Builup Area</label><b style="color:red;">*</b>
                                <input type="number" name="warehouseBuildupArea" id="warehouseBuildupArea" onkeypress="return event.charCode >= 48" min="0" onkeyup="check_area()" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseBuildupArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin:0;padding:0;">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label style="color:red;" id="warehouseSuperBuildupArea_error"></label>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label style="color:red;" id="warehouseBuildupArea_error"></label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="CoveredArea" id="CoveredArea" onkeypress="return event.charCode >= 48" min="0" onkeyup="check_area()" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseBuildupArea; } ?>" >
                                <span id="CoveredArea_error"></span>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseOpenArea" id="warehouseOpenArea" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseOpenArea; } ?>" >
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <label style="color:red;" id="CoveredArea_error"></label>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Pentry</label>
                                <input type="number" name="warehousePentry" id="warehousePentry" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehousePentry; } ?>" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Pentry Used For</label>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseRoadWide" id="warehouseRoadWide" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseRoadWide; } ?>"  >
                            </div>
                                
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Road Wide Unit</label>
                                <select id="warehouseRoadWideUnit" name="warehouseRoadWideUnit" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseRoadWideUnit == 'Sqft'){ echo 'selected'; } } ?> >FT</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="warehouseBathroom" id="warehouseBathroom" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($warehouse_details)){ echo $warehouse_details->warehouseBathroom; } ?>" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Bathroom For</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select id="warehouseHeavyVehicleParkingUpto" name="warehouseHeavyVehicleParkingUpto" >
                                    ...
                                    <option value="6Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '6Wheeler'){ echo 'selected'; } } ?>>6 Wheeler</option>
                                    <option value="8Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '8Wheeler'){ echo 'selected'; } } ?>>8 Wheeler</option>
                                    <option value="10Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '10Wheeler'){ echo 'selected'; } } ?>>10 Wheeler</option>
                                    <option value="12Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '12Wheeler'){ echo 'selected'; } } ?>>12 Wheeler</option>
                                    <option value="14Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '14Wheeler'){ echo 'selected'; } } ?>>14 Wheeler</option>
                                    <option value="16Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '16Wheeler'){ echo 'selected'; } } ?>>16 Wheeler</option>
                                    <option value="18Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '18Wheeler'){ echo 'selected'; } } ?>>18 Wheeler</option>
                                    <option value="20Wheeler" <?php if(!empty($warehouse_details)){ if($warehouse_details->warehouseHeavyVehicleParkingUpto == '20Wheeler'){ echo 'selected'; } } ?>>20 Wheeler</option>
                                </select>
                            </div>
...
<script>
	function add()
	{
        ...
        $("#warehouseNumberofCabin").val('');
        $("#warehouseSuperBuildupArea").val('');
        $("#warehouseSuperBuildupAreaUnit").val('');
        $("#warehouseCoveredAreaUnit").val('');
        $("#CoveredArea").val('');
        $("#warehouseFloor").val('');
        $("#warehouseroof").val('');
        ...
        $("#warehouseNumberofWorkStation").val('');
        $("#warehouseBuildupArea").val('');
        $("#warehouseOpenArea").val('');
        $("#warehouseBuildupAreaUnit").val('');
        $("#warehouseOpenAreaUnit").val('');
        $("#warehouseTotalFloor").val('');
        $("#warehousePentry").val('');
        $("#warehouseBathroom").val('');
        $("#warehousePentryUsedFor").val('');
        $("#warehouseBathroomUsedFor").val('');
...
<script>
    function edit_seller(post_id, mode)
    {
        ...
        ({
            ...
            data: {post_id:post_id, property_type:'Warehouse'},
            dataType: 'json',
            success: function(data)
            {
                ...
                $("#warehouseNumberofCabin").val(data['warehouseNumberofCabin']);
                $("#warehouseSuperBuildupArea").val(data['warehouseSuperBuildupArea']);
                $("#warehouseSuperBuildupAreaUnit").val(data['warehouseSuperBuildupAreaUnit']);
                $("#CoveredArea").val(data['warehouseCoveredArea']);
                $("#warehouseCoveredAreaUnit").val(data['warehouseCoveredAreaUnit']);
                $("#warehouseFloor").val(data['warehouseFloor']);
                ...
                $("#warehouseNumberofWorkStation").val(data['warehouseNumberofWorkStation']);
                $("#warehouseBuildupArea").val(data['warehouseBuildupArea']);
                $("#warehouseOpenArea").val(data['warehouseOpenArea']);
                $("#warehouseBuildupAreaUnit").val(data['warehouseBuildupAreaUnit']);
                $("#warehouseOpenAreaUnit").val(data['warehouseOpenAreaUnit']);
                $("#warehouseTotalFloor").val(data['warehouseTotalFloor']);
                $("#warehousePentry").val(data['warehousePentry']);
                $("#warehouseBathroom").val(data['warehouseBathroom']);
                $("#warehousePentryUsedFor").val(data['warehousePentryUsedFor']);
                $("#warehouseBathroomUsedFor").val(data['warehouseBathroomUsedFor']);
    ...
    function check_area(){
        if(parseInt($('#warehouseBuildupArea').val()) < parseInt($('#warehouseSuperBuildupArea').val())){
            $('#warehouseBuildupArea_error').html('Should be less than superbuiltup area');
        }else{
            $('#warehouseBuildupArea_error').html('');
        }
        if(parseInt($('#CoveredArea').val()) > parseInt($('#warehouseBuildupArea').val())){
            $('#CoveredArea_error').html('Should be less than builtup area');
        }else{
            $('#CoveredArea_error').html('');
        }
    }
</script>
