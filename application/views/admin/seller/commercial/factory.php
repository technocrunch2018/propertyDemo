        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_rent_factory');?>" enctype = "multipart/form-data">
                        <?php }else{?>
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/saller_com_sell_factory');?>" enctype = "multipart/form-data">
                            <?php }?>
                        <div class="tab"> 
                ...
                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                    <?php if($rent_sell == 'Rent'){ ?>
                    <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_rent_factory.xlsx');?>">Download Demo File</a>
                    <?php }else{?>
                    <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/seller_commercial/saller_com_sell_factory.xlsx');?>">Download Demo File</a>
                    <?php }?>
                </div>
            </div>
            
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10"><h2>Factory List</h2></div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_sale_factory_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/seller_commercial_rent_factory_not_int');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php } ?>
                    ...
                    <form name="commercial_factory_form" id="commercial_factory_form" method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_seller">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" name="name" id="name" style="text-transform: uppercase;"  />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Factory No</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="factory_super_buildup_area" id="factory_super_buildup_area" onkeyup="check_area()" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_super_buildup_area; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="factory_BuildupArea" id="factory_BuildupArea" onkeyup="check_area()" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_BuildupArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="factory_carpet_area" id="factory_carpet_area" onkeyup="check_area()" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_carpet_area; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Open Area</label>
                                 <input type="number" name="factory_OpenArea" id="factory_OpenArea" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_OpenArea; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Pentry</label>
                                <input type="number" name="factory_pentry" id="factory_pentry" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_pentry; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Bathroom</label>
                                 <input type="number" name="factory_Bathroom" id="factory_Bathroom" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_Bathroom; } ?>"  >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="factory_roadWide" id="factory_roadWide" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_roadWide; } ?>">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="factory_roadWide_unit" name="factory_roadWide_unit" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft"  <?php if(!empty($factory_details)){ if($factory_details->factory_roadWide_unit == 'Sqft'){ echo 'selected'; } } ?> >FT</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="factory_ElectricPower" id="factory_ElectricPower" onkeypress="return event.charCode >= 48" min="0" value="<?php if(!empty($factory_details)){ echo $factory_details->factory_ElectricPower; } ?>" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="electrical_unit" name="electrical_unit" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft"  <?php if(!empty($factory_details)){ if($factory_details->factory_roadWide_unit == 'Sqft'){ echo 'selected'; } } ?> >KG</option>
                                    <option value="Sq-m"  <?php if(!empty($factory_details)){ if($factory_details->factory_roadWide_unit == 'Sq-m'){ echo 'selected'; } } ?> >HR Power</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <select id="factory_HeavyVehicleParkingUpto" name="factory_HeavyVehicleParkingUpto" >
                                    ...
                                    <option value="6Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '6Wheeler'){ echo 'selected'; } } ?>>6 Wheeler</option>
                                    <option value="8Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '8Wheeler'){ echo 'selected'; } } ?>>8 Wheeler</option>
                                    <option value="10Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '10Wheeler'){ echo 'selected'; } } ?>>10 Wheeler</option>
                                    <option value="12Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '12Wheeler'){ echo 'selected'; } } ?>>12 Wheeler</option>
                                    <option value="14Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '14Wheeler'){ echo 'selected'; } } ?>>14 Wheeler</option>
                                    <option value="16Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '16Wheeler'){ echo 'selected'; } } ?>>16 Wheeler</option>
                                    <option value="18Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '18Wheeler'){ echo 'selected'; } } ?>>18 Wheeler</option>
                                    <option value="20Wheeler" <?php if(!empty($factory_details)){ if($factory_details->factory_HeavyVehicleParkingUpto == '20Wheeler'){ echo 'selected'; } } ?>>20 Wheeler</option>
                                </select>
                            </div>
