                    ...
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" onclick="edit_factory(<?php echo $row->factory_id; ?>);"><i class="fa fa-pencil"></i></a> |
                                    <a href="<?php echo base_url(); ?>backend/delete_factory/<?php echo $row->factory_id; ?>" onclick="return confirm('Do you want to delete this record?');"> <i class="fa fa-trash"></i></a>
                                    <!-- <a   href="creat.php?id=<?php echo $row->factory_id;?>"><i class="fa fa-tasks" aria-hidden="true"></i></a> -->
                                </td>  
                            </tr>
                            <?php } ?>
                            <?php } ?>
    ...
    <div class="modal-dialog  modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>backend/save_factory">
                    ...
                    <input type="hidden" name="factory_id" value="0" id="factory_id" style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                    ...
                    <div class="tab"> 
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            ...
                            <input type="text" onkeypress='return isNumberKey(event)' name="pincode" id="pincode" style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                    ...
                    <div class="tab">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="text" size=20 maxlength=15 onkeypress='return isNumberKey(event)' name="security_deposite" id="security_deposite"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Rent / Month</label><b style="color:red;">*</b>
                            <input type="text" size=20 maxlength=15 onkeypress='return isNumberKey(event)' name="rent_month" id="rent_month"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Furnished Status</label><b style="color:red;">*</b>
                                <select name="furnish_status" id="furnish_status" style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                    <option value="">---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="super_built_up_area_unit" id="super_built_up_area_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option value="">---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select name="built_up_area_unit" id="built_up_area_unit" style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option value="">---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select name="covered_area_unit" id="covered_area_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option value="">---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="text" name="factory_number" id="factory_number"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="pentry_user_for" id="pentry_user_for"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option value="">---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select placeholder="sqft/MT" name="road_wide_unit" id="road_wide_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option value="">---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="text" name="manufacturing_type" id="manufacturing_type"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="date" placeholder="DD/MM/YYYY" name="possession_date" id="possession_date" style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="properties_type_end" id="properties_type_end"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option value="">---Select---</option>
                    ...
                    <div class="tab">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <br>
                            <input type="checkbox" value="Power Backup"  name="power_backup" id="power_backup"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Power Backup

                            <br>
                            <input type="checkbox" value="Lift" name="lift" id="lift" style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Lift

                            <br>
                            <input type="checkbox" value="Services" name="service_lift" id="service_lift"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Service Lift

                            <br>
                            <input type="checkbox" value="Security" name="security" id="security"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Security

                            <br>
                            <input type="checkbox" value="CCTV" name="cctv" id="cctv"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> CCTV
                            <br>
                            <input type="checkbox" value="Visitor Parking" name="visitor_parking" id="visitor_parking" style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Visitor Parking
                            <br>
                            <input type="checkbox" value="Conference Room" name="conference_room" id="conference_room" style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Conference Room
                            <br>
                            <input type="checkbox" value="Reception" name="reception" id="reception"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Reception
                            <br>
                            <input type="checkbox" value="Wifi" name="wifi" id="wifi"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> WIFI
                            <br>
                            <input type="checkbox" value="Intercom" name="intercom" id="intercom"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Intercom
                            <br>
                            <input type="checkbox" value="Two Wheeler Parking" name="two_wheeler_parking" id="two_wheeler_parking"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Two Wheeler Parking
                            <br>
                            <input type="checkbox" value="Water" name="water" id="water" style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Water
                        </div> 
                        <div class="col-md-12 col-sm-12 col-xs-12">
...
<script type="text/javascript">
    function edit_factory(factory_id){
        $.ajax({
            url: "<?php echo base_url(); ?>backend/get_factory_details_by_id",
            ...
            success:function(info){
                ...
                $("#furnish_status").val(data['furnish_status']);
                ...
                $("#factory_number").val(data['factory_number']);
                ...
                $("#pentry_user_for").val(data['pentry_user_for']);
                $("#roof").val(data['roof']);
                $("#bathroom").val(data['bathroom']);
                $("#bathroom_use_for").val(data['bathroom_use_for']);
                $("#road_wide").val(data['road_wide']);
                $("#road_wide").val(data['road_wide']);
                $("#road_wide_unit").val(data['road_wide_unit']);
                $("#heavy_vehicle_parking").val(data['heavy_vehicle_parking']);
                $("#electric_power").val(data['electric_power']);
                $("#electric_power_unit").val(data['electric_power_unit']);
                $("#manufacturing_type").val(data['manufacturing_type']);
                $("#possession").val(data['possession']);
                $("#possession_date").val(data['possession_date']);
                $("#open").val(data['open']);
                $("#covered").val(data['covered']);
                $("#basement").val(data['basement']);
                $("#lift_parking").val(data['lift_parking']);
                $("#age_of_properties").val(data['age_of_properties']);
                $("#properties_type_end").val(data['properties_type_end']);
