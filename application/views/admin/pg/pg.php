        ...
        <div class="x_panel">
            <div class="x_title">
             <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <a href = "<?php echo base_url('backend/add_pg');?>"><button class="effect red effect-5 pull-right" style="width:150px;">Add PG</button></a>
                </div>
            </div>
                ...
                <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>   
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url();?>home/pg_details/<?=$row->id;?>" target="_BLANK"><span title="View Details" class="label label-info">View Details</span></a></td>
                                <td>
                			        <a href = "<?php echo base_url('backend/edit_pg/'. $row->id);?>" > <span title="Edit" class="label label-default">Edit</span></a>
                                    <?php if($row->status == 1){?>
                                    <a onclick="return confirm('Do You want to change status of this record?');" href="<?php echo base_url();?>backend/approve_pg/0/<?php echo $row->id;?>"><span title="Approve" class="label label-success">Active</span></a>
                                    <?php }if($row->status == 0){?>
                                    <a onclick="return confirm('Do You want to change status of this record?');" href="<?php echo base_url();?>backend/approve_pg/1/<?php echo $row->id;?>"><span title="Reject" class="label label-warning">Deactive</span></a>
                                    <?php } ?>
                                    <?php if($this->session->userdata('user_type') != 'admin'){ ?>
                                    <a onclick="return confirm('Do You want to delete this record?');" href="<?php echo base_url();?>backend/delete_pg/<?php echo $row->id;?>"><span title="Delete" class="label label-danger">Delete</span></a>
                                    <?php } ?>
                                </td>
