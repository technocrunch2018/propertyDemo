            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>               
                            <?php if(!empty($list_shop)){ ?>
                            <?php foreach($list_shop as $i=>$row){ ?>
                            <tr>
                                <td><?php echo $i+1;?></td>
                                ...
                                <td>
                                    <div class="container">
                                        <button type="button" style="background-color:#212121" class="btn btn-info btn-lg" data-toggle="modal" data-target="#<?php echo $row->a;?>"><i class="fa fa-eye" aria-hidden="true"></i>
                                        </button>
                                        
                                        <div class="modal fade" id="<?php echo $row->a;?>" role="dialog">
                                ...
                                <td>
                                    <div class="container">
                                        <button type="button" style="background-color:#212121" class="btn btn-info btn-lg" data-toggle="modal" data-target="#<?php echo $row->d;?>"><i class="fa fa-eye" aria-hidden="true"></i>
                                        </button>
                                
                                        <div class="modal fade" id="<?php echo $row->d;?>" role="dialog">
                                            <div class="modal-dialog">
                                ...
                                <td>
                                    <div class="container">
                                        <button type="button" style="background-color:#212121" class="btn btn-info btn-lg" data-toggle="modal" data-target="#<?php echo $row->c;?>"><i class="fa fa-eye" aria-hidden="true"></i>
                                        </button>
                                
                                        <div class="modal fade" id="<?php echo $row->c;?>" role="dialog">
                                            <div class="modal-dialog">
                                ...
                                <td>
                                    <div class="container">
                                        <button type="button" style="background-color:#212121" class="btn btn-info btn-lg" data-toggle="modal" data-target="#<?php echo $row->i;?>"><i class="fa fa-eye" aria-hidden="true"></i>
                                        </button>
                                
                                        <div class="modal fade" id="<?php echo $row->i;?>" role="dialog">
                                            <div class="modal-dialog">
                                ...
                                <td>
                                    <a href="javascript:void(0);" onclick="edit_shop(<?php echo $row->shop_id;?>)"><i class="fa fa-pencil"></i></a>
                                    <a onclick="return confirm('Do you want to delete this record?');" href="<?php echo base_url();?>backend/delete_shop/<?php echo $row->shop_id;?>"> <i class="fa fa-trash"></i></a>
    ...
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>backend/save_shop">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="property_id" value="<?php echo rand(10000,999999)?>" id="property_id"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /><input type="hidden" name="shop_id" value="0" id="shop_id"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="text" name="land_mark" id="land_mark"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Pincode</label><b style="color:red;">*</b>
                            <input onkeypress='return isNumberKey(event)' type="text" name="pin_code" id="pin_code"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input onkeypress='return isNumberKey(event)' maxlength=15  type="text" name="security_deposite" id="security_deposite"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Rent / Month</label><b style="color:red;">*</b>
                            <input onkeypress='return isNumberKey(event)' maxlength=15 type="text" name="rent_month" id="rent_month"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="number" min=0 name="frontage" id="frontage"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select placeholder="Ft/Mt" name="frontage_unit" id="frontage_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  >
                                <option>---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select name="super_built_up_area" id="super_built_up_area"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                                <option>---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select placeholder="sqft v" name="built_up_area_unit" id="built_up_area_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option>---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="number" min=0 name="open_area" id="open_area"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select placeholder="sqft v" name="open_area_unit" id="open_area_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select name="covered_area" id="covered_area"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option>---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Shop Number</label><b style="color:red;">*</b>
                            <input type="text" name="shop_number" id="shop_number"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="bathroom_use_for" id="bathroom_use_for"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Use For</label><b style="color:red;">*</b>
                            <select name="pentry_use_for" id="pentry_use_for"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                                <option value="Personal">Personal</option>
                                <option value="Common">Common</option>
                            </select>         
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="number" min=0 name="road_wide" id="road_wide"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>


                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select   name="road_wide_unit" id="road_wide_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                                <option value="Sq-ft">Sq-ft</option>
                                <option value="Sq-yrd">Sq-yrd</option>
                                <option value="Sq-m">Sq-m</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="available_for_war" id="available_for_war"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="restaurant" id="restaurant"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>         
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="number" min=0 name="electric_power" id="electric_power"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>


                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Unit</label><b style="color:red;">*</b>
                            <select name="electric_power_unit" id="electric_power_unit"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  >
                            <option>---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select  name="heavy_vehicle_parking" id="heavy_vehicle_parking"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
                                <option>---Select---</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="number" min=0   name="open_parking" placeholder=" " id="open_parking"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Covered Parking</label><b style="color:red;">*</b>
                            <input type="number" min=0 placeholder=" "   name="covered_parking" id="covered_parking"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>

                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <label>Basement Parking</label><b style="color:red;">*</b>
                            <input type="number" min=0 name="basement_parking" placeholder=" " id="basement_parking"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select name="roof" id="roof"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                <option>---Select---</option>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <br><input type="checkbox" value="Conference Room" name="conference_room" id="conference_room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Conference Room
                            ...
                            <br><input type="checkbox" value="Two Wheeler" name="two_wheeler_parking" id="two_wheeler_parking"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Two Wheeler Parking
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input type="file" name="image" id="file"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            <input type="hidden" name="prev_image" id="prev_image"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                        </div>
...
<script>
	function deleteRecord(id)
	{
		...
		if(x==true)
		{
			window.location="shop_rent_delete.php?did="+id;
		}
...
<script type="text/javascript">
    function edit_shop(shop_id){
        $.ajax({
            url: "<?php echo base_url(); ?>backend/get_shop_details_by_id",
            ...
            success:function(info){
                ...
                $("#pentry_use_for").val(data['pentry_use_for']);
                ...
                $("#open_parking").val(data['open_parking']);
                $("#open_parking").val(data['covered_parking']);
                $("#basement_parking").val(data['basement_parking']);
                $("#lift_parking").val(data['lift_parking']);
                $("#age_of_properties").val(data['age_of_properties']);
                $("#roof").val(data['roof']);
                $("#property_type").val(data['property_type']);
                $("#power_backup").val(data['power_backup']);
                $("#description").html(data['description']);
                $("#prev_image").val(data['image']);
