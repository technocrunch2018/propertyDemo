...
error:function (){}
      ...
      <div class="modal-content">
		...
		<form method="POST">
          <div class="row">
			  ...
			  <fieldset>
				<input class="input--style-5"   type="text" name="phone"   required  style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)">
  ...
  <p><img src="gi.gif" id="loaderIcon" style="display:none;height:90px;width:150px;" /></p>
			  ...
			  <label>Select One</label><b style="color:red;">*</b>
				<select name="sell_rent" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
 ...
 <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Select One</label><b style="color:red;">*</b>
				<select name="sell_rent" id="com_res"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
					<option>---Select---</option>
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Select One</label><b style="color:red;">*</b>
				<select name="h_p_l" id="com_res"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
					<option>---Select---</option>
					<option value="Duplex Flat">Duplex Flat</option>
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Select One</label><b style="color:red;">*</b>
 			  ...
 			  <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Minimum Rent</label><b style="color:red;">*</b>
			  ...
			  <label>Minimum Area Required</label><b style="color:red;">*</b>
				<input type="number" name="min_area_required" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>
			  ...
			  <label>Unit</label><b style="color:red;">*</b>
				<select name="b_unit" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
            ...
            <option value="kottah">kottah</option>
			   ...
			   <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Minimum Floor Height</label><b style="color:red;">*</b>
			  ...
			  <label>Maximum Floor Height</label><b style="color:red;">*</b>
				<input type="text" name="max_floor_height" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>
			 
			 
			 	 <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Flat No</label><b style="color:red;">*</b>
				<input type="number" name="flate_no" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>

			  <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Lower Floor No</label><b style="color:red;">*</b>
				<input type="number" name="l_f_n" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>

			   <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Uper Floor No</label><b style="color:red;">*</b>
				<input type="number" name="u_f_n" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>
			   

			  <div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Total Floor</label><b style="color:red;">*</b>
				<input type="number" name="total_floor" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>

			  
            <div class="col-md-3 col-sm-3 col-xs-3">
			  <label>Room</label><b style="color:red;">*</b>
				<input type="number" name="room" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
			  </div>
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
			 ...
			 <div class="col-md-12 col-sm-12 col-xs-12">
			  <label>Amenities</label><b style="color:red;">*</b>
 				<br><input type="checkbox" value="Yes"  name="power_backup" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"/> Power Backup

 				<br><input type="checkbox" value="Yes" name="intercom" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Intercom

 				<br><input type="checkbox" value="Yes" name="lift" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />  Lift

 				<br><input type="checkbox" value="Yes" name="services_lift" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />Service  Lift

 				<br><input type="checkbox" value="Yes" name="security" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Security

 				<br><input type="checkbox" value="Yes" name="cctv" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> CCTV
			  
		<br><input type="checkbox" value="Yes" name="wifi" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> WIFI
			  

			  <br><input type="checkbox" value="Yes" name="banquet_hall" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Banquet Hall

			  <br><input type="checkbox" value="Yes" name="swimming" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Swimming Pool


			  <br><input type="checkbox" value="Yes" name="community_hall" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Community Hall

<br><input type="checkbox" value="Yes" name="gym" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Gym

<br><input type="checkbox" value="Yes" name="club_house" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Club House

<br><input type="checkbox" value="Yes" name="indoor_game" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Indoor Game

<br><input type="checkbox" value="Yes" name="outdoor_game" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Outdoor Game


<br><input type="checkbox" value="Yes" name="park" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Park

<br><input type="checkbox" value="Yes" name="vigitor_parking" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Visitor Parking

<br><input type="checkbox" value="Yes" name="gas_pipe_line" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Gas Pipe Line

<br><input type="checkbox" value="Yes" name="security" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> 24 Hr.Security

<br><input type="checkbox" value="Yes" name="sarvant_room" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Sarvant Room
 ...
 <div class="col-md-12 col-sm-12 col-xs-12	">
			  <label>Description</label><b style="color:red;">*</b>
 				<textarea   maxlength="100" placeholder="100 words only" name="decription" id="room"style="padding:3px;border: 1px solid #dddd;width:100%;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"></textarea>
			  </div>
