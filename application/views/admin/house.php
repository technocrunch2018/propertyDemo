...
<?php
    ...
    $lower_floor=$_POST['lower_floor'];
    $uper_floor=$_POST['uper_floor'];
    ...
    $cctv=$_POST['cctv'];
    $wifi=$_POST['wifi'];
    $banquet_hall=$_POST['banquet_hall'];
    $swimming=$_POST['swimming'];
    $community_hall=$_POST['community_hall'];
    $gym=$_POST['gym'];
    $club_house=$_POST['club_house'];
    $indoor_game=$_POST['indoor_game'];
    $outdoor_game=$_POST['outdoor_game'];
    $park=$_POST['park'];
    $vigitor_parking=$_POST['vigitor_parking'];
    $gas_pipe_line=$_POST['gas_pipe_line'];
    $sarvant_room=$_POST['sarvant_room'];
    $c=$_POST['c'];
    $d=$_POST['d'];
    $i=$_POST['i'];
    $a=$_POST['a'];
    $video=$_POST['video'];
    $carpet_area_nit=$_POST['carpet_area_nit'];
    $imgname = $_FILES['file']['name'];

    echo $sql="insert into house_rent (name,mobile,mobile_official,phone,email,country,state,city,location,land_mark,pin_code,address,rent_sell,com_res,type,category,security_deposite,rent_month,furnished_status,complex_society_building_name,super_built_up_area,built_up_area,built_up_area_unit,carpet_area,block_number,flat_number,lower_floor,uper_floor,total_floor,roof,room,bathroom,balcony,kitchen,possession,possession_date,open_parking,covered_parking,basment,lift_parking,age_of_properties,property_type,description,image,added_by,flat_id,power_backup,intercom,lift,service_lift,security,cctv,wifi,banquet_hall,swimming,community_hall,gym,club_house,indoor_game,outdoor_game,park,vigitor_parking,gas_pipe_line,sarvant_room,c,i,d,a,video,carpet_area_nit,pooja_room)
    value ('$name','$mobile','$mobile_official','$phone','$email','$country','$state','$city','$location','$land_mark','$pin_code','$address','$rent_sell','$com_res','$type','$category','$security_deposite','$rent_month','$furnished_status','$complex_society_building_name','$super_built_up_area','$built_up_area','$built_up_area_unit','$carpet_area','$block_number','$flat_number','$lower_floor','$uper_floor','$total_floor','$roof','$room','$bathroom','$balcony','$kitchen','$possession','$possession_date','$open_parking','$covered_parking','$basment','$lift_parking','$age_of_properties','$property_type','$description','$imgname','$added_by','$flat_id','$power_backup','$intercom','$lift','$service_lift','$security','$cctv','$wifi','$banquet_hall','$swimming','$community_hall','$gym','$club_house','$indoor_game','$outdoor_game','$park','$vigitor_parking','$gas_pipe_line','$sarvant_room','$c','$i','$d','$a','$carpet_area_nit','$video','$pooja_room')";*/    
?>
<script>
...
<div class="right_col" role="main">
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fa fa-ioxhost"></i> Manage House</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>House List</h2>
                    <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">+ADD House</button>
                    ...
                    <table id="datatable" class="table table-bordered table-striped table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $rows11['carpet_area'];?><?php echo $rows11['carpet_area_nit'];?></td>
                                <td><?php echo $rows11['lower_floor'];?></td>
                                <td><?php echo $rows11['uper_floor'];?></td>
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add House</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <input type="hidden"  name="flat_id" value="<?php echo rand(100000,9000000)?>" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Mobile</label><b style="color:red;">*</b>
                                <input type="text" size=20 maxlength=15 onkeypress='return isNumberKey(event)' name="mobile_official" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <input type="text" name="pin_code" onkeypress='return isNumberKey(event)' id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                                </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <input onkeypress='return isNumberKey(event)' maxlenght=15 type="number" min=0 name="security_deposite" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Rent/Month</label><b style="color:red;">*</b>
                                <input onkeypress='return isNumberKey(event)' maxlenght=15 type="number" min=0 name="rent_month" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Furnished Status</label><b style="color:red;">*</b>
                                <select name="furnished_status" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
                                    <option>---Select---</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>House No</label><b style="color:red;">*</b>
                                <input type="number" min=0 name="flat_number" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Pooja Room</label><b style="color:red;">*</b>
                                <input type="number" min=0 name="pooja_room" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0   name="open_parking" placeholder=" " id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name=" " placeholder="Basement" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <br><input type="checkbox" value="power_backup" name="power_backup" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"/> Power Backup
                                ...
                                <br><input type="checkbox" value="service_lift" name="service_lift" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />Service  Lift
                                ...
                                <br><input type="checkbox" value="banquet_hall" name="banquet_hall" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Banquet Hall
                                <br><input type="checkbox" value="swimming" name="swimming" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Swimming Pool
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <br><input type="checkbox" value="community_hall" name="community_hall" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Community Hall
                                <br><input type="checkbox" value="gym" name="gym" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Gym
                                <br><input type="checkbox" value="club_house" name="club_house" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Club House
                                <br><input type="checkbox" value="indoor_game" name="indoor_game" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Indoor Game
                                <br><input type="checkbox" value="outdoor_game" name="outdoor_game" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Outdoor Game
                                <br><input type="checkbox" value="park" name="park" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Park
                                <br><input type="checkbox" value="vigitor_parking" name="vigitor_parking" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Visitor Parking
                                <br><input type="checkbox" value="gas_pipe_line" name="gas_pipe_line" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Gas Pipe Line
                                <br><input type="checkbox" value="security" name="security" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> 24 Hr.Security
                                <br><input type="checkbox" value="sarvant_room" name="sarvant_room" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Sarvant Room
                            </div>
