    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3><i class="fa fa-ioxhost"></i> Manage Sub Elements</h3>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="action-btn delete"
                                            ...
                                            href="<?php echo base_url();?>backend/delete_subelement/<?php echo $row->id;?>">
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog  modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo base_url(); ?>backend/save_subemelement"
