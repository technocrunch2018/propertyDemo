			    ...
			    <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                      <div class="x_title">
                        ...
                        <form action="<?php echo base_url('backend/manage_admin_perfomance'); ?>" method="post" name="get_admin_performance" id="get_admin_performance">
                        <div class="col-md-3">
                            ...
                            <tbody>
                                <?php foreach($users as $i=>$user){?>
                                 <tr>
                    				  ...
                    				  <td><?php echo @$user->achieved_amount; ?></td>
                     				  <td><?php echo @$user->remaining_amount; ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <form action="<?php echo base_url('backend/manage_admin_perfomance'); ?>" method="post" name="get_performance_by_admin_id" id="get_performance_by_admin_id">
                                <div class="col-md-3">
...
var horizontalBarChart = new Chart(horizontalBarChartCanvas, {
   type: 'horizontalBar',
   data: {
      labels: ["Client", "Owner", "Lead Partner", "Home Loan", "Advertisement"],
      datasets: [{
         /*data: [280, 380, 480, 290, 120],*/
         data: <?php echo json_encode($info); ?>,
         backgroundColor: ["#ffe0e6", "#ffe0e6", "#ffe0e6", "#ffe0e6", "#ffe0e6"], 
      }]
   },
   options: {
      tooltips: {
