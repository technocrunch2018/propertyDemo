            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10">
                         <h2>Not Interested Factory List</h2>
                    </div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_sale_factory');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_rent_factory');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php } ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="number" class="input--style-5" name="phone" id="phone" onblur="checkValue(this)" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="MinimumOpenArea" id="MinimumOpenArea">
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="MinimumOpenAreaUnit" name="MinimumOpenAreaUnit">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="MaximumOpenArea" id="MaximumOpenArea">
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="MaximumOpenAreaUnit" name="MaximumOpenAreaUnit">
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft">Sqft</option>
                                    <option value="Sq-m">Sq-m</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Min Covered Area</label><b style="color:red;">*</b>
                                <input type="number" name="MinimumCoveredArea" id="MinimumCoveredArea">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Max Covered Area</label><b style="color:red;">*</b>
                                <input type="number" name="MaximumCoveredArea" id="MaximumCoveredArea">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="SuperBuildupArea" id="SuperBuildupArea">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="BuildupArea" id="BuildupArea">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <label>Number of WorkStation</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="number" name="Pentry" id="Pentry" class="gui-input" value="">
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Bathroom</label><b style="color:red;">*</b>
                                <input type="number" name="Bathroom" id="Bathroom" class="gui-input" value="" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="RoadWide" id="RoadWide" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="ElectricPower" id="ElectricPower">
                            </div>
