            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_com_rent_showroom');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_com_sell_showroom');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_com_rent_showroom.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_com_sell_showroom.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="x_title">
                    ...
                    <a href = "<?php echo base_url('property/buyer_commercial_sale_shop_showroom_not_intersted');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_rent_shop_showroom_not_interested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php } ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="mobile2" id="mobile2" onkeypress="return event.charCode >= 48" min="0" />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Phone</label>
                                <input type="number" class="input--style-5"  name="phone" id="phone"  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;" onblur="checkValue(this)" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <input maxlenght=15 type="number" min=0 name="MinimumRent" id="MinimumRent" required onkeypress="return event.charCode >= 48" />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Max Budget</label><b style="color:red;">*</b>
                                <input maxlenght=15 type="number" min=0 name="MaximumRent" id="MaximumRent" required onkeypress="return event.charCode >= 48" />
                            </div>
                            
                            
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Nature of Business</label>
                                <input type="text" name="ShopNatureofBusiness" id="ShopNatureofBusiness" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Frontage</label>
                                <input type="number" name="Frontage" id="Frontage" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="ShopMinimumAreaRequired" id="ShopMinimumAreaRequired" required onkeypress="return event.charCode >= 48" min="0" >
                            </div>

                           <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="MinimumAreaRequiredUnit" name="MinimumAreaRequiredUnit" required >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="text" name="ShopMaximumAreaRequired" id="ShopMaximumAreaRequired" onkeypress="return event.charCode >= 48" min="0" required >
                            </div>

                           <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="ShopMaximumAreaRequiredUnit" name="ShopMaximumAreaRequiredUnit" required  >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft">Sqft</option>
                                    <option value="Sq-m">Sq-m</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="text" name="SuperBuildupArea" id="SuperBuildupArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                           ...
                           <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="text" name="CoveredArea" id="CoveredArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                           ...
                           <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="text" name="BuildupArea" id="BuildupArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                           ...
                           <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="text" name="OpenArea" id="OpenArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <label>Pentry</label>
                                <input type="number" name="Pentry" id="Pentry" class="gui-input" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Used For</label>
                                <select id="penhtry_user_for" name="penhtry_user_for">
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="RoadWide" id="RoadWide" class="gui-input" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <input type="number" name="Bathroom" id="Bathroom" class="gui-input" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Used For</label>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>ElectricPower</label>
                                <input type="number" name="ElectricPower" id="ElectricPower" class="gui-input" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <select id="AvailableForBar" name="AvailableForBar" >
                                    <option hidden value="">Available For Bar</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <select id="ForResturant" name="ForResturant">
                                    <option hidden value="">Available For Resturant</option>
                                    <option value="Yes" >Yes</option>
                                    <option value="No" >No</option>
                                </select>
                            </div>
