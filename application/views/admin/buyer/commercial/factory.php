            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_com_rent_factory');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_com_sell_factory');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_com_rent_factory.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_com_sell_factory.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="x_title">
                    ...
                    <a href = "<?php echo base_url('property/buyer_commercial_sale_factory_not_interested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_rent_factory_not_interested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    <?php } ?>
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    ...
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Factory Requirement</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Mobile</label>
                                <input type="number"  name="mobile2" id="mobile2" onblur="checkValue(this)" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" onkeypress="return event.charCode >= 48" min="0" />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Phone</label>
                                <input type="number" class="input--style-5" name="phone" id="phone" onblur="checkValue(this)" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;" onkeypress="return event.charCode >= 48" min="0">
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="MinimumOpenArea" id="MinimumOpenArea" onkeypress="return event.charCode >= 48" min="0" required >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="MinimumOpenAreaUnit" name="MinimumOpenAreaUnit" required >
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Max OpenArea</label><b style="color:red;">*</b>
                                <input type="number" name="MaximumOpenArea" id="MaximumOpenArea" onkeypress="return event.charCode >= 48" min="0" required >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select id="MaximumOpenAreaUnit" name="MaximumOpenAreaUnit" required >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft">Sqft</option>
                                    <option value="Sq-m">Sq-m</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Min Covered Area</label>
                                <input type="number" name="MinimumCoveredArea" id="MinimumCoveredArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label>
                                <select id="MinimumCoveredAreaUnit" name="MinimumCoveredAreaUnit">
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft">Sqft</option>
                                    <option value="Sq-m">Sq-m</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Max Covered Area</label>
                                <input type="number" name="MaximumCoveredArea" id="MaximumCoveredArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Unit</label>
                                <select id="MaximumCoveredAreaUnit" name="MaximumCoveredAreaUnit">
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sqft">Sqft</option>
                                    <option value="Sq-m">Sq-m</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="SuperBuildupArea" id="SuperBuildupArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="BuildupArea" id="BuildupArea" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <select id="NumberofCabin" name="NumberofCabin">
                                    <option hidden value="">Number of Cabin</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <select id="NumberofWorkStation" name="NumberofWorkStation">
                                    <option hidden value="">No of Work Station</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                                    <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                    <?php } ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <label>Pentry</label>
                                <input type="number" name="Pentry" id="Pentry" class="gui-input" value="" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="Bathroom" id="Bathroom" class="gui-input" value="" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Used For</label>
                                <select id="bathroom_user_for" name="bathroom_user_for">
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <option value="Personal" <?php if(!empty($shop_details)){ if($shop_details->bathroom_user_for == 'Personal'){ echo 'selected'; } } ?> >Personal</option>
                                    <option value="Common" <?php if(!empty($shop_details)){ if($shop_details->bathroom_user_for == 'Common'){ echo 'selected'; } } ?> >Common</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="RoadWide" id="RoadWide" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="ElectricPower" id="ElectricPower" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <select id="ElectricPowerUnit" name="ElectricPowerUnit">
                                    ...
                                    <option value="HR Power" >HR Power</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select id="HeavyVehicleParkingUpto" name="HeavyVehicleParkingUpto">
                                    <option hidden value="">Heavy Vehicle Parking Upto</option>
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" name="NatureofBusiness" id="NatureofBusiness">
                            </div>
...
<script>
	function add()
	{
        ...
        $("#MinimumOpenArea").val('');
        $("#MinimumCoveredArea").val('');
        $("#MinimumOpenAreaUnit").val('');
        $("#MinimumCoveredAreaUnit").val('');
        $("#roof").val('');
        $("#ElectricPower").val('');
        $("#ElectricPowerUnit").val('');
        $("#NatureofBusiness").val('');
        $("#MaximumOpenArea").val('');
        $("#MaximumCoveredArea").val('');
        $("#MaximumOpenAreaUnit").val('');
        $("#MaximumCoveredAreaUnit").val('');
    ...
    function edit_buyer(post_id, mode)
    {
        ...
        ({
            ...
            success: function(data)
            {
                ...
                $("#MinimumOpenArea").val(data['MinimumOpenArea']);
                $("#MinimumCoveredArea").val(data['MinimumCoveredArea']);
                $("#MinimumOpenAreaUnit").val(data['MinimumOpenAreaUnit']);
                $("#MinimumCoveredAreaUnit").val(data['MinimumCoveredAreaUnit']);
                $("#roof").val(data['roof']);
                ...
                $("#MaximumOpenArea").val(data['MaximumOpenArea']);
                $("#MaximumCoveredArea").val(data['MaximumCoveredArea']);
                $("#MaximumOpenAreaUnit").val(data['MaximumOpenAreaUnit']);
                $("#MaximumCoveredAreaUnit").val(data['MaximumCoveredAreaUnit']);
