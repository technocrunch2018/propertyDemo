            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_com_rent_office');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_com_sell_office');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_com_rent_office.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_com_sell_office.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="x_title">
                    ...
                    <a href = "<?php echo base_url('property/buyer_commercial_sale_office_not_interested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_rent_office_not_interested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php } ?>
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    ...
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Office Requirement</h4>
                </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" size=20 maxlength=10 name="mobile" id="mobile" onkeypress="return event.charCode >= 48" min="0" required />
                            </div>

                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Alt. Mobile</label>
                                <input type="number" size=20 maxlength=15 name="mobile2" id="mobile2" onkeypress="return event.charCode >= 48" min="0" />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Phone</label>
                                <input type="number" class="input--style-5" name="phone" id="phone" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <select id="NumberofCabin" name="NumberofCabin" required >
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <?php for($i = 1; $i<=100; $i++){ ?>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Mini Area</label><b style="color:red;">*</b>
                                <input type="number" min=0 name="OfficeMinimumAreaRequired" id="OfficeMinimumAreaRequired" onblur="checkValue(this)" onkeypress="return event.charCode >= 48" min="0" required  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Min Area Unit</label><b style="color:red;">*</b>
                                <select name="OfficeSuperBuildupAreaUnit" id="OfficeSuperBuildupAreaUnit" onblur="checkValue(this)" required >
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Maxi Area</label><b style="color:red;">*</b>
                                <input type="number" min=0 name="MaximumAreaRequired" id="MaximumAreaRequired"  onblur="checkValue(this)" onkeypress="return event.charCode >= 48" min="0" required  />
                            </div>
                            
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Max Area Unit</label><b style="color:red;">*</b>
                                <select name="OfficeMaximumAreaRequiredUnit" id="OfficeMaximumAreaRequiredUnit"  onblur="checkValue(this)" required >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                                    <option value="Sq-yrd">Sq-yrd</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Mini Floor Height</label>
                                <select  name="OfficeMinimumFloorHeight" id="OfficeMinimumFloorHeight" onblur="checkValue(this)" >
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Maxi Floor Height</label>
                                <select  name="OfficeMaximumFloorHeight" id="OfficeMaximumFloorHeight" onblur="checkValue(this)" >
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <option value="G">G</option>
                                    <option value="1">1</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Pentry</label>
                                <input type="number" name="Pentry" id="Pentry" onkeypress="return event.charCode >= 48" min="0">
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                               ...
                               <input type="number" name="OfficeBathroom" id="OfficeBathroom" onkeypress="return event.charCode >= 48" min="0" >
                            </div>
                            
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Used For</label>
                                <select id="BathroomUsedFor" name="BathroomUsedFor"  >
                                    <option hidden value="">--Select--</option>
                                    <option disabled >Select one </option>
                                    <option value="Personal">Personal</option>
                                    <option value="Common">Common</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" name="OfficeNatureofBusiness" id="OfficeNatureofBusiness" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="CarpetArea" id="CarpetArea"  onblur="checkValue(this)" onkeypress="return event.charCode >= 48" min="0" />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="BuildupArea" id="BuildupArea"  onblur="checkValue(this)" onkeypress="return event.charCode >= 48" min="0" />
                            </div>
...
<script>
	function add()
	{
        ...
        $("#OfficeMinimumAreaRequired").val('');
        $("#OfficeSuperBuildupAreaUnit").val('');
        $("#OfficeMinimumFloorHeight").val('');
        $("#Pentry").val('');
        $("#PentryUsedFor").val('');
        $("#AC").val('');
        $("#MaximumAreaRequired").val('');
        $("#OfficeMaximumAreaRequiredUnit").val('');
        ...
        $("#OfficeMaximumFloorHeight").val('');
        $("#OfficeBathroom").val('');
        $("#OfficeNatureofBusiness").val('');
    ...
    function edit_buyer(post_id, mode)
    {
        ...
        ({
            ...
            success: function(data)
            {
                ...
                $("#OfficeMinimumAreaRequired").val(data['MinimumAreaRequired']);
                $("#OfficeSuperBuildupAreaUnit").val(data['OfficeSuperBuildupAreaUnit']);
                $("#OfficeMinimumFloorHeight").val(data['OfficeMinimumFloorHeight']);
                $("#Pentry").val(data['Pentry']);
                $("#PentryUsedFor").val(data['PentryUsedFor']);
                $("#AC").val(data['AC']);
                $("#MaximumAreaRequired").val(data['MaximumAreaRequired']);
                $("#OfficeMaximumAreaRequiredUnit").val(data['OfficeMaximumAreaRequiredUnit']);
                ...
                $("#OfficeMaximumFloorHeight").val(data['OfficeMaximumFloorHeight']);
                $("#OfficeBathroom").val(data['OfficeBathroom']);
                $("#OfficeNatureofBusiness").val(data['OfficeNatureofBusiness']);
