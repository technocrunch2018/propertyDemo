            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10">
                         <h2>Not Interested Office List</h2>
                    </div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_sale_office');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_rent_office');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php } ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" size=20 maxlength=10 name="mobile" id="mobile" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" required/>
                            </div>

                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Alt. Mobile</label><b style="color:red;">*</b>
                                <input type="number" size=20 maxlength=15 name="mobile2" id="mobile2" onblur="checkValue(this)" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Phone</label><b style="color:red;">*</b>
                                <input type="number" class="input--style-5" name="phone" id="phone" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==15) return false;">
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Mini Budget</label><b style="color:red;">*</b>
                                <input maxlenght=15 type="number" min=0 name="MinimumRent" id="MinimumRent" />
                            </div>

                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Maxi Budget</label><b style="color:red;">*</b>
                                <input maxlenght=15 type="number" min=0 name="MaximumRent" id="MaximumRent" />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label>Work Stations</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="OfficeMinimumAreaRequired" id="OfficeMinimumAreaRequired" onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Min Area Unit</label><b style="color:red;">*</b>
                                <select name="OfficeSuperBuildupAreaUnit" id="OfficeSuperBuildupAreaUnit" onblur="checkValue(this)" >
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="MaximumAreaRequired" id="MaximumAreaRequired"  onblur="checkValue(this)"  />
                            </div>
                            
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Max Area Unit</label><b style="color:red;">*</b>
                                <select name="OfficeMaximumAreaRequiredUnit" id="OfficeMaximumAreaRequiredUnit"  onblur="checkValue(this)" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                                    <option value="Sq-yrd">Sq-yrd</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Mini Floor Height</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Maxi Floor Height</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" name="Pentry" id="Pentry">
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>UsedFor</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                               ...
                               <input type="number" name="OfficeBathroom" id="OfficeBathroom" >
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 pt-10 pb-10">
                                <label style="color:#444;">Additional Info</label><b style="color:red;">*</b>
                            </div>
                            
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>SuperBuildup Area</label><b style="color:red;">*</b>
