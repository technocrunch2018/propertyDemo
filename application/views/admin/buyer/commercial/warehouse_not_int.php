            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10">
                         <h2>Not Interested Warehouse List</h2>
                    </div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_sale_warehouse');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_commercial_rent_warehouse');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php } ?>
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Min CoveredArea</label><b style="color:red;">*</b>
                                <input type="number" min=0 name="WarehouseMinimumCoveredArea" id="WarehouseMinimumCoveredArea" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Max CoveredArea</label><b style="color:red;">*</b>
                                <input type="number" min=0 name="WarehouseMaximumCoveredArea" id="WarehouseMaximumCoveredArea" onblur="checkValue(this)"  />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="WarehouseMinimumOpenArea" id="WarehouseMinimumOpenArea"  onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="WarehouseMinimumOpenAreaUnit" id="WarehouseMinimumOpenAreaUnit"  onblur="checkValue(this)" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                                    <option value="Sq-yrd">Sq-yrd</option>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="WarehouseMaximumOpenArea" id="WarehouseMaximumOpenArea"  onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="WarehouseMaximumOpenAreaUnit" id="WarehouseMaximumOpenAreaUnit"  onblur="checkValue(this)" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                                    <option value="Sq-yrd">Sq-yrd</option>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <label>Vehicle Parking Upto</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <label>Min Floor</label><b style="color:red;">*</b>
