            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_res_rent_penthouse');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_res_sell_penthouse');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_res_rent_penthouse.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_res_sale_penthouse.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="x_title">
                    ...
                    <a href = "<?php echo base_url('property/buyer_residential_sale_pent_house_not_intrested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_rent_pent_house_not_interested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                    <?php } ?>
                    <!-- <a href = "<?php echo base_url('property/buyer_residential_sale_pent_house_not_intrested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a> -->
        ...
        <div class="modal-dialog  modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
                    ...
                    <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Pent House Requirement</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            <input type="hidden" name="added_by" value="Super Admin" id="added_by" />
                            <input type="hidden" name="post_id" value="0" id="post_id"    />
                            <input type="hidden" name="residential" value="PentHouse" id="residential"    />
                            <input type="hidden" name="residential_commercial" value="Residential" id="residential_commercial"    />
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" size=20 maxlength=15 name="mobile2" id="mobile2" />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>E-mail</label>
                                <input type="text" name="email" id="house_email"  style="text-transform: lowercase;"  />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="FlatMinimumAreaRequired" id="FlatMinimumAreaRequired" onblur="checkValue(this)"  required />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="SuperBuildupAreaUnit" id="SuperBuildupAreaUnit" onblur="checkValue(this)" required >
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="FlatMaximumAreaRequired" id="FlatMaximumAreaRequired"  onblur="checkValue(this)"  required />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="BuildupAreaUnit" id="BuildupAreaUnit"  onblur="checkValue(this)" required >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 pt-10 pb-10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Open Terrace Area</label>
                                <input type="number" min=0 name="openTerrace" id="openTerrace" onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="openTerraceUnit" id="openTerraceUnit" onblur="checkValue(this)" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer_not_interested">
                        <div class="row">
                            <input type="hidden" name="buyer_not_interested_post_id" value="0" id="buyer_not_interested_post_id"    />
    ...
    function edit_buyer(post_id, mode)
    {
        ...
        ({
            ...
            success: function(data)
            {
                ...
                $("#openTerrace").val(data['openTerrace']);
                $("#openTerraceUnit").val(data['openTerraceUnit']);
