            ...
            <div class="x_panel">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_res_rent_flat');?>" enctype = "multipart/form-data">
                            <?php }else{?>
                            <form method = "POST" action = "<?php echo base_url('Excel_uploads/buyer_res_sell_flat');?>" enctype = "multipart/form-data">
                                <?php }?>
                            <div class="tab"> 
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
                        <?php if($rent_sell == 'Rent'){ ?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_res_rent_flat.xlsx');?>">Download Demo File</a>
                        <?php }else{?>
                        <a class="outln-hvr" href = "<?php echo base_url('Uploads/excels/buyer/Flat/buyer_res_sale_flat.xlsx');?>">Download Demo File</a>
                        <?php }?>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="x_title">
                    <div class="row">
                        ...
                        <a href = "<?php echo base_url('property/buyer_residential_sale_flat_not_intrested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                        <?php }else{ ?>
                        <a href = "<?php echo base_url('property/buyer_residential_rent_flat_not_intrested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Interested</button></a>
                        <?php } ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type=number size=20 maxlength=10 name="mobile" id="mobile" />
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label>Phone</label>
                                <input type="number" class="input--style-5" size=20 maxlength=15 name="phone" id="phone" >
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <select name="BuildupAreaUnit" id="BuildupAreaUnit"  onblur="checkValue(this)" required >
                                    <option Select disabled value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                                    <option value="Sq-yrd">Sq-yrd</option>
                                    <option value="Sq-m">Sq-m</option>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 pt-10 pb-10">
                                <label style="color:#444;">Additinal Info</label>
                            </div>
