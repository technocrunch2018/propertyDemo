            ...
            <div class="x_panel">
               <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10">
                        <h2>Not Interested House/Bunglow List</h2>
                    </div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_sale_house_bunglow');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_rent_house_bunglow');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php } ?>
                    <!-- <a href = "<?php echo base_url('property/buyer_residential_sale_house_bunglow_not_intrested');?>"><button type="button" class="effect effect-5 blue pull-right">Not Intrested</button></a>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="MinimumAreaRequired" id="MinimumAreaRequired" onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="StockMinimumAreaRequiredUnit" id="StockMinimumAreaRequiredUnit" onblur="checkValue(this)" >
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                ...
                                <input type="number" min=0 name="HouseMaximumAreaRequired" id="HouseMaximumAreaRequired"  onblur="checkValue(this)"  />
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Unit</label><b style="color:red;">*</b>
                                <select name="HouseMaximumOpenAreaUnit" id="HouseMaximumOpenAreaUnit"  onblur="checkValue(this)" >
                                    <option hidden value="">Unit</option>
                                    <option disabled >Select one </option>
                                    <option value="Sq-ft">Sq-ft</option>
                                    <option value="Sq-yrd">Sq-yrd</option>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Total Area</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Uncovered Area</label><b style="color:red;">*</b>
