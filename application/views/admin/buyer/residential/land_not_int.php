            ...
            <div class="x_panel">
               <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10">
                        <h2>Not Intrested Land List</h2>
                    </div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_sale_land');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_rent_land');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php } ?>
