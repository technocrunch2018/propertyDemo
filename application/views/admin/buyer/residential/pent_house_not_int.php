        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="x_title">
                    <div class="col-md-3 col-sm-6 col-xs-12 xs-pb-10">
                        <h2>Not Interested Pent House List</h2>
                    </div>
                    <?php if($rent_sell == 'Sell'){ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_sale_pent_house');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php }else{ ?>
                    <a href = "<?php echo base_url('property/buyer_residential_rent_pent_house');?>"><button type="button" class="effect effect-5 blue pull-right">Interested</button></a>
                    <?php } ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>property/save_buyer">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="name" name="name" id="name" style="text-transform: uppercase;" required />
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                ...
                                <input type="number" size=20 maxlength=15 name="mobile2" id="mobile2" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;"  />
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 pt-10 pb-10">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Super Area</label><b style="color:red;">*</b>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6">
                                <label>Open Terrace Area</label><b style="color:red;">*</b>
