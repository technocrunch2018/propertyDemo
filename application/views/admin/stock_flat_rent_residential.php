          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-ioxhost"></i> Manage stock flat</h3>
              </div>
              </div>
            ...
            <div class="row">
			  <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>stock flat List</h2>
					<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">+ADD stock flat</button>
    ...
    <div class="modal-dialog  modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
          ...
          <h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add stock flat</h4>
        </div>
 ...
 <div class="col-md-6 col-sm-6 col-xs-6">
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
			  <label>Select One</label><b style="color:red;">*</b>
				<select name="h_p_l" id="com_res"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
					<option>---Select---</option>
					<option value="stock flat">stock flat</option>
  ...
  <div class="col-md-6 col-sm-6 col-xs-6">
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
			 ...
			 <div class="col-md-12 col-sm-12 col-xs-12">
			  <label>Amenities</label><b style="color:red;">*</b>
 				...
 				<br><input type="checkbox" name="lift" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />  Lift

 				<br><input type="checkbox" name="services_lift" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />Service  Lift
		...
		<br><input type="checkbox" name="wifi" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> WIFI
			  ...
			  <br><input type="checkbox" name="banquet_hall" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Banquet Hall

			  <br><input type="checkbox" name="swimming" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Swimming Pool


			  <br><input type="checkbox" name="community_hall" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Community Hall

<br><input type="checkbox" name="gym" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Gym

<br><input type="checkbox" name="club_house" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Club House

<br><input type="checkbox" name="indoor_game" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Indoor Game

<br><input type="checkbox" name="outdoor_game" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Outdoor Game


<br><input type="checkbox" name="park" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Park

<br><input type="checkbox" name="vigitor_parking" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Visitor Parking

<br><input type="checkbox" name="gas_pipe_line" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Gas Pipe Line

<br><input type="checkbox" name="security" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> 24 Hr.Security

<br><input type="checkbox" name="sarvant_room" id="room"style="padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  /> Sarvant Room
