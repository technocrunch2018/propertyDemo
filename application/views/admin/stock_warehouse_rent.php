...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="title_left">
			<h3><i class="fa fa-ioxhost"></i> Manage Ware House</h3>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="x_panel">
				<div class="x_title">
					<h2>Ware House Sell List</h2>
					<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">+ADD Ware House</button>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a  class="btn btn-danger"onclick="deleteRecord(<?php echo $rows11['id'];?>)" href="javascript:void(0)"> <i class="fa fa-trash"></i></a>
								</td>
							</tr>
		...
		<div class="modal-dialog  modal-lg">
			...
			<div class="modal-content">
				<div class="modal-header" style="background:linear-gradient(to right,#03709e,#18c3fd 100%);">
					...
					<h4 class="modal-title" style="color:white;font-weight:bold;font-size:20px;">Add Ware House</h4>
				</div>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								<select name="s_w_f_l" id="com_res"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)" >
									...
									<option value="Ware House or Showroom">Ware House or Showroom</option>
									<option value="Ware House">Ware House</option>
									<option value="Ware House">Ware House</option>
									<option value="Land">Land</option>
								</select>	
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								<input type="text" name="min_price" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								<input type="text" name="natute_of_business" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								...
								<input type="text" name="c_s_b_n" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Minimum Open Area</label><b style="color:red;">*</b>
								<input type="number" name="min_open_area" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								...
								<input type="number" name="Max_open_area" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="text" placeholder="sqft v" name="b_unit" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Minimum Covered Area</label><b style="color:red;">*</b>
								<input type="number" name="minimum_covered_area" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Maximum Open Area</label><b style="color:red;">*</b>
								<input type="number" name="open_area" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="text" placeholder="sqft v" name="b_unit" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Mini Floor</label><b style="color:red;">*</b>
								<input type="number" name="mini_floor" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Max  Floor</label><b style="color:red;">*</b>
								<input type="number" name="max_floor" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								...
								<input type="number" name="road_wide" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="text" placeholder="sqft v" name="b_unit" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Heavy Vehicle Parking</label><b style="color:red;">*</b>
								<input type="text" placeholder="3 Wheeler /4 Wheeler" name="heavy_vehicle" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
