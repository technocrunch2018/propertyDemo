					...
					<form method="POST">
						<div class="row">
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Minimum Opne Area</label><b style="color:red;">*</b>
								<input type="number" name="m_o_a" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Minimum Convered Area</label><b style="color:red;">*</b>
								<input type="number" name="m_c_a" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="text" placeholder="sqft v" name="s_unit" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label> Maximum Covered Area</label><b style="color:red;">*</b>
								<input type="number" name="m_c_aa" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="text" placeholder="sqft v" name="b_unit" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							...
							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="number" placeholder="sqft/MT" name="unit_s" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>

							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Heavy Vechile Parking Upto</label><b style="color:red;">*</b>
								<input type="heavy_vehicle_parking_upto" placeholder="3 wheeler/ 4 wheeler" name="unit_s" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>


							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Electric Power</label><b style="color:red;">*</b>
								<input type="number"   name="electric_power" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>

							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Nature Of Business</label><b style="color:red;">*</b>
								<input type="text" maxlength="50" placeholder="50 letters"   name="electric_power" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>

							<div class="col-md-3 col-sm-3 col-xs-3">
								<label>Unit</label><b style="color:red;">*</b>
								<input type="text" placeholder="KG/Hr Power" name="unit_s" id="room"style="width: 100%;height:32px;padding:3px;border: 1px solid #dddd;border-radius: 4px;box-sizing: border-box;margin-top: 3px;margin-bottom:3px;resize: vertical;" onblur="checkValue(this)"  />
							</div>
